...
See [schema documentation](docs/schema.md), the [ER diagram](docs/er-diagram.md), [API notes](docs/api.md), the [ChatGPT Actions guide](docs/chatgpt-actions.md), the [versioned OpenAPI schema](docs/openapi.json), the [Supabase workflow](docs/supabase.md), and the [development guide](docs/development.md).
