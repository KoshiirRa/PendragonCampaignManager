...
erDiagram
    ...
    WINTER_PHASES ||--o{ ANNUAL_CHRONICLES : produces
    ANNUAL_CHRONICLES ||--o{ ANNUAL_CHRONICLE_SECTIONS : contains
    CHARACTERS ||--o{ ANNUAL_CHRONICLE_SECTIONS : remembers
    ANNUAL_CHRONICLES ||--o{ ANNUAL_CHRONICLE_SOURCES : cites
    EVENTS ||--o{ ANNUAL_CHRONICLE_SOURCES : supports
