...
Use `py -3.14 -m alembic upgrade head` when applying migrations through the application toolchain.

The numbered SQL files in this directory are canonical. Run
`py -3.14 scripts/sync_supabase_migrations.py` after changing one; generated copies under
